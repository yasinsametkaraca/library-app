...
public class BookListItemResponse {
    ...
    public static BookListItemResponse from(Book book) {
        return  BookListItemResponse.builder()  //build ile yapıyoruz çünkü bookdan BookListItemResponse a dönüşüm yapıyoruz. Bunu önceden BookListItemResponse classın içinde constructorda yapıyorduk
                .id(book.getId())
                .title(book.getTitle())
